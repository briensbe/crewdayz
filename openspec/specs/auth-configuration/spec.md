...
Fournir une gestion et un contrôle de l'activation des fournisseurs d'authentification (spécifiquement Google OAuth) via les fichiers d'environnement Angular.
